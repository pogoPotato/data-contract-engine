...
class APIClient:
    ...
    def get_validation_results(self, contract_id: str, limit: int = 100) -> List[Dict]:
        params = {"limit": limit}
        return self._request("GET", f"validate/{contract_id}/results", params=params)
    
    def get_contract_versions(self, contract_id: str) -> List[Dict]:
        return self._request("GET", f"contracts/{contract_id}/versions")
    ...
    def get_daily_metrics(self, contract_id: str, days: int = 30) -> List[Dict]:
        params = {"days": days}
        return self._request("GET", f"metrics/{contract_id}/daily", params=params)
